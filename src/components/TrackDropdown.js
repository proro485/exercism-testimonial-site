...
export default function TrackDropdown(props) {
  ...
  return (
    <div className="trackDropDown relative cursor-pointer" onClick={() => setDropDown(!dropDown)} onMouseLeave={() => setDropDown(false)}>
      ...
      {
        dropDown && <div className="dropdown max-h-[32vh] w-[380px] overflow-x-visible overflow-y-auto bg-white absolute z-10 p-2 rounded-lg shadow-[0_4px_42px_0px_rgba(79,114,205,0.15)]"
        >
          {
